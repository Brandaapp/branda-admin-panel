        ...
        <nav>
          <div className="nav-wrapper grey lighten-5">
            ...
            <ul className="right hide-on-med-and-down">
              ...
              <li>
                <a className="dropdown-trigger" style={{ height: "100%" }} href="#!" data-target="#dropdown1" data-beloworigin="true" data-hover="true">
                  <img className="circle circle-small" src="/logo.png"/>
                </a>
              </li>
            </ul>
          </div>
